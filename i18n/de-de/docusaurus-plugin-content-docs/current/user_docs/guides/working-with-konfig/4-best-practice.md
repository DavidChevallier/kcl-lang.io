...
## Best Practices für Konfig Modeling
...
### Use Literal Type und Union Type
...
Numbers with units in KCL have a built-in type of `units.NumberMultiplier`, und any arithmetic operations are not allowed.
