...
This command runs the kcl code und displays the output. 'kcl run' takes multiple input für arguments.
...
Examples:
  # Run a single file und output YAML
  kcl run path/to/kcl.k

  # Run a single file und output JSON
